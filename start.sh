...
nohup python3 Hector/HectorServer.py > Server.out 2>&1 &
nohup python3 Hector/HectorController.py > Controller.out 2>&1 &
nohup sudo python3 Hector/LEDStripServer.py > /dev/null 2>&1 &
